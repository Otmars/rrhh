    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles"> Eventos/Actividades </h1>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-10 col-md-offset-1">
                                            <form action="Backend/subir2.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="Backend/delete3.php?id=<?php echo $row['ID_Eventos'] ?>" class="btn btn-danger btn-raised btn-xs"><i class="zmdi zmdi-delete"></i></a></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
