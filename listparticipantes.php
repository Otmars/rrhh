    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles text-center"> Registrar Código </h1>
                <center>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-10 col-md-offset-1">
                                            <form action="Backend/subir4.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Código de Certificado</label>
                                    ...
                                    <table id="tabla" class="table table-striped">
                                        <thead class="thead-inverse">
                                            <tr>
                                                ...
                                                <th class="text-center">Código de Certificado</th>
